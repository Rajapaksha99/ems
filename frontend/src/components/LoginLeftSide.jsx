...
const LoginLeftSide = () => {
  return (
    ...
    relative overflow-hidden border-r border-slate-100'>
        <div className='absolute -top-28 -left-28 w-72 h-72 bg-indigo-500/20 rounded-full blur-3xl'></div>
        <div className='relative z-10 flex flex-col items-start justify-center p-12 lg:p-20 w-full h-full'>
            ...
            <p className='text-slate-400 text-lg max-w-md leading-relaxed'>
              Streamline your workspace operation, track attendance, manage payroll, 
